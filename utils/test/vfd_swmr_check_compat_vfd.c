 ...
 *              supports SWMR.  It also checks for parallel HDF5, where page
 *              buffering is disabled and thus can't be used for VFD SWMR.
 *
 ...
 *              VFD SWMR (page buffering, which VFD SWMR depends on, is
 *              disabled for parallel).
 *
