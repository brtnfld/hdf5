...
H5Pset_file_space_strategy(hid_t plist_id, H5F_fspace_strategy_t strategy, bool persist, hsize_t threshold)
{
    ...
    /* Any additional sanity checking may need to be replicated in H5F__load_vfd_swmr_fs_strategy_config()
     *              -- Cody S. 5/15/26 */
...
H5Pset_file_space_page_size(hid_t plist_id, hsize_t fsp_size)
{
    ...
    /* Any additional sanity checking may need to be replicated in H5F__load_vfd_swmr_fs_page_size_config()
     *              -- Cody S. 5/15/26 */
