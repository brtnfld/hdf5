...
H5_DLL herr_t H5CL_parse_config(const char *input_str_ptr, char *expected_name_ptr, H5CL_nv_pair_t nv_pairs[],
                                int num_pairs);
H5_DLL herr_t H5CL_parse_config_group(const char *input_str_ptr, char *config_group_name_ptr, int num_configs,
