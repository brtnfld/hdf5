...
H5_DLL herr_t H5C_evict_tagged_entries(H5F_t *f, haddr_t tag, bool match_global, bool do_refresh,
                                       uint64_t tick);
...
H5_DLL bool   H5C_get_curr_read_speculative(H5C_t *cache_ptr);
...
H5_DLL herr_t H5C_set_vfd_swmr_reader(H5C_t *cache_ptr, bool vfd_swmr_reader, hsize_t page_size);
